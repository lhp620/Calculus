/* ═══════════════════════════════════════════════════════════
   AP Calculus AB/BC — Firebase Auth + Firestore Sync
   Google Sign-In, cross-device progress sync
   ═══════════════════════════════════════════════════════════ */

const Auth = (() => {
  const USERS_COL   = 'calc_users';
  const STORAGE_KEY = 'calc_progress_v1';
  const SYNC_KEY    = 'calc_firebase_synced'; // sessionStorage flag to prevent reload loops
